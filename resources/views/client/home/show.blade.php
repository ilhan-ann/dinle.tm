    ...
    <div class="container-lg">
        <div class="row">
            ...
            <div class="col-12 col-md-9">
                ...
                <div class="mb-4 mt-2">
                    <p class="text-uppercase mb-1" style="color: var(--sp-gray-1); font-size: 0.75rem; font-weight: 600; letter-spacing: 0.1em;">Category</p>
                    <h1 class="fw-black mb-0" style="font-size: clamp(2rem, 6vw, 4rem); letter-spacing: -0.02em;">{{ $category->name }}</h1>
