...
@section('content')
    ...
    <div class="container-lg">
        <div class="row mb-5">
            ...
            <section class="contact-section glass-nav p-5 my-5 rounded-5 position-relative overflow-hidden">
                <div class="container text-center">
                    ...
                    <form action="#" method="POST" class="contact-form mx-auto text-start mt-4">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn glass btn-glass text-black px-5 py-2 rounded-4">
